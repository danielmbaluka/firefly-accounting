<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">Set voucher SL <span class="label badge-success">{{glaccount.segmentAccountCode}} {{glaccount.description}}</span> <span class="label badge-success">{{sltotalamount}}</span></h4>
</div>
