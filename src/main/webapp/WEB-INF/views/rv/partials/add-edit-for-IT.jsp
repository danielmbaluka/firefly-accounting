...
<div class="row">
    <div class="col-md-12 col-lg-12">
        ...
        <div class="col-md-5 col-lg-5" id="radio">
            <div class="radio">
                <label>
                    <input id="optionsRadios1" ng-model="rvItType.id" ng-change="nameChange(rvItType.id)" type="radio" name="optionsRadios" value="1"/>
                    Hardware
                </label>
            </div>
            <div class="radio">
                <label>
                    <input id="optionsRadios2" ng-model="rvItType.id" ng-change="nameChange(rvItType.id)" type="radio" name="optionsRadios" value="2"/>
                    Software
                </label>
            </div>
            <div class="radio">
                <label>
                    <input id="optionsRadios3" ng-model="rvItType.id" type="radio" name="optionsRadios" value="3"/>
                    Others
                    <input id="optionsRadios4" ng-model="rvItType.name" type="text" name="optionsRadios"/>
                </label>
            </div>
        </div>
...
<div class="row">
    <div class="col-md-12 col-lg-12">
        ...
        <div class="col-md-5 col-lg-5">
            <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-filter"></i></span>
                <input disabled="" ng-model="rv.conformedBy.name" id="conform" name="conform" class="form-control ng-pristine ng-valid" type="text" placeholder="Browse Conforming Officer"/>
            </div>
        </div>
        <div class="col-md-5 col-lg-5">
            <button sl-entity-browser
                    handler="conform_selection_handler"
                    types="signatories"
                    class="btn btn-primary">&nbsp;<i class="fa fa-chevron-up" title="Browse Conforming Officer"></i>&nbsp;</button>
        </div>
        <form-error err_field="errors.err_conOfficer"></form-error>
    </div>
</div>
