        ...
        <div class="col-md-7 col-lg-7">
            <div class="table-responsive white-bg">
                <table class="table table-striped">
                    <thead>
                    <tr>
                        <th colspan="2"><textarea ng-model="item.joDescription" maxlength="1024" rows="4" cols="35" id="purpose1"
                    ...
                    <tr>
                        ...
                        <th>Quantity</th>
                        <th>Unit</th>
                        <th><button class="btn btn-primary" item-browser handler="item_selection_handler" >Add item</button></th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr ng-repeat="item in poItems">
                        ...
                        <td style="width: 15%; text-align: right"><input style="width: 90%; text-align: right;" type="number" min="1" ng-model="item.quantity" ng-show="item.itemCode">{{ item.itemCode == null ? item.quantity : ''}}</td>
                        <td>{{ item.unitCode }}</td>
                        <td style="text-align: center"><a ng-click="test($index)" ng-show="item.itemCode" item-browser handler="item_selection_handler2" style="padding: 0" title="Update"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;<a ng-click="removeRow($index)" style='padding: 0' title='Remove'><i class='fa fa-minus'></i></a></td>
                    </tr>
