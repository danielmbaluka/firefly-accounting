            ...
            <div class="col-md-6 col-lg-6">
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="col-md-9 col-lg-9">
                            <label class="value-label"><span class="label {{statusLabel}}">{{selectedMIR.status}}</span></label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="col-md-9 col-lg-9">
                            <label class="value-label">{{selectedMIR.voucherDate | date:'MMM dd, yyyy'}}</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="col-md-9 col-lg-9">
                            <label class="value-label">{{selectedMIR.particulars}}</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-6">
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="col-md-8 col-lg-8">
                            <label class="value-label">{{selectedMIR.sLChecker.name}}</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="col-md-8 col-lg-8">
                            <label class="value-label">{{selectedMIR.sLApprovingOfficer.name}}</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="col-md-8 col-lg-8">
                            <label class="value-label">{{selectedMIR.lastUpdated | date:'MMM dd, yyyy HH:mm a'}}</label>
                        </div>
                    </div>
                </div>
            </div>
