<div ui-view>
    <div ng-controller="addEditMirCtrl">
        ...
        <div class="ibox-content">
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12">
                    <div class="alert alert-info">{{title}} <span class="label label-success">{{mir.code}}</span></div>
                </div>
            </div>
                                ...
                                <div class="table-responsive white-bg" style="max-height: 400px; overflow: auto">
                                    <table class="table table-striped">
                                        ...
                                        <tr ng-repeat="entry in journalEntries">
                                            ...
                                            <td style="text-align: center"><a ng-click="setSelectedIdx($index)" account-browser-modal handler="account_selection_handler" style='padding: 0' title='Account'><i class='fa fa-angellist'></i></a>&nbsp;&nbsp;<a ng-click="loadExistingSlEntries(entry, $index)" voucher-sl-setter handler="voucher_sl_setter_handler" slentries="glSlEntries" glaccount="selectedGlAccount" slloaded="slLoaded" sltotalamount="glAmountForSL" style='padding: 0' segments="segments" title='SL'><i class='fa fa-user'></i></a>&nbsp;&nbsp;<a ng-click="removeJournalRow($index, entry)" style='padding: 0' title='Remove'><i class='fa fa-minus'></i></a></td>
                                        </tr>
