            ...
            <div class="col-md-6 col-lg-6">
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="col-md-9 col-lg-9">
                            <label class="value-label"><span class="label {{statusLabel}}">{{cashReceipts.documentStatus.status}}</span></label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="col-md-9 col-lg-9">
                            <label class="value-label">{{cashReceipts.voucherDate | date:'MMM dd, yyyy'}}</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="col-md-9 col-lg-9">
                            <label class="value-label">{{cashReceipts.particulars}}</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-6">
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="col-md-8 col-lg-8">
                            <label class="value-label">{{cashReceipts.amount | currency : "" : 2}}</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="col-md-8 col-lg-8">
                            <label class="value-label">{{cashReceipts.checker.name}}</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="col-md-8 col-lg-8">
                            <label class="value-label">{{cashReceipts.approvingOfficer.name}}</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="col-md-8 col-lg-8">
                            <label class="value-label">{{cashReceipts.lastUpdated | date:'MMM dd, yyyy HH:mm a'}}</label>
                        </div>
                    </div>
                </div>
            </div>
