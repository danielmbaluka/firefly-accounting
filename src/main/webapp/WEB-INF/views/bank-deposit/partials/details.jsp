        ...
        <div class="col-lg-12">
            ...
            <div class="col-md-6 col-lg-6">
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="col-md-9 col-lg-9">
                            <label class="value-label"><span class="label {{statusLabel}}">{{bankDeposit.documentStatus.status}}</span></label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        <div class="col-md-3 col-lg-3">
                            <label class="input-label">Deposit Date</label>
                        </div>
                        <div class="col-md-9 col-lg-9">
                            <label class="value-label">{{bankDeposit.depositDate | date:'MMM dd, yyyy'}}</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        <div class="col-md-3 col-lg-3">
                            <label class="input-label">Slip Number</label>
                        </div>
                        <div class="col-md-9 col-lg-9">
                            <label class="value-label">{{bankDeposit.depositNumber}}</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-6">
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="col-md-8 col-lg-8">
                            <label class="value-label">{{bankDeposit.amount | currency : "" : 2}}</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="col-md-8 col-lg-8">
                            <label class="value-label">{{bankDeposit.checker.name}}</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="col-md-8 col-lg-8">
                            <label class="value-label">{{bankDeposit.approvingOfficer.name}}</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="col-md-8 col-lg-8">
                            <label class="value-label">{{bankDeposit.lastUpdated | date:'MMM dd, yyyy HH:mm a'}}</label>
                        </div>
                    </div>
                </div>
            </div>
