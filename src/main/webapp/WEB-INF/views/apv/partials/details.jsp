    ...
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="col-md-8 col-lg-8">
                <h2>{{apv.localCode}} <span class="bold"> {{apv.vendor.name}}</span></h2>
            </div>
            ...
            <div class="col-md-6 col-lg-6">
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="col-md-9 col-lg-9">
                            <label class="value-label"><span class="label {{statusLabel}}">{{apv.documentStatus.status}}</span></label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="col-md-9 col-lg-9">
                            <label class="value-label">{{apv.voucherDate | date:'MMM dd, yyyy'}}</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="col-md-9 col-lg-9">
                            <label class="value-label">{{apv.dueDate | date:'MMM dd, yyyy'}}</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="col-md-9 col-lg-9">
                            <label class="value-label">{{apv.particulars}}</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-6">
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="col-md-8 col-lg-8">
                            <label class="value-label">{{apv.amount | currency : "" : 2}}</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="col-md-8 col-lg-8">
                            <label class="value-label">{{apv.checker.name}}</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="col-md-8 col-lg-8">
                            <label class="value-label">{{apv.approvingOfficer.name}}</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="col-md-8 col-lg-8">
                            <label class="value-label">{{apv.lastUpdated | date:'MMM dd, yyyy HH:mm a'}}</label>
                        </div>
                    </div>
                </div>
            </div>
