(function () {
    ...
    app.directive('voucherSlSetter', ['$timeout', function ($timeout) {
        return {
            scope : {
                slentries: "=",
                segments: "=",
                        ...
                        controller: function($scope, $modalInstance) {
                            ...
                            $scope.entity_selection_handler = function(object){
                                ...
                                $scope.slentries[$scope.entryIdx] =
                                {
                                    ...
                                    "accountId": $scope.glaccount.accountId,
                ...
                elem.bind('click', function () {
                    ...
                    if (scope.slloaded) {
                        ...
                        scope.$watch(scope.slloaded, function() {
                            if (scope.glaccount !== undefined && !$.isEmptyObject(scope.glaccount) && scope.glaccount.hasOwnProperty('accountId')) {
