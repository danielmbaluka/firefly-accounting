...
public class GeneralLedger extends Ledger implements Serializable {
    ...
    public GeneralLedger(ArrayList<SubLedgerDto> subLedgerLines) {
        this.subLedgerLines = subLedgerLines;
    }

    public GeneralLedger(BigDecimal debit, BigDecimal credit, Transaction transaction, SegmentAccount segmentAccount,
